...
<section class="hero-section">
    <div class="container">
        ...
        <p class="fw-semibold mb-4">Avoid the administrative dissolution of your company — stay compliant and in Good Standing with New York State.</p>
        
        @if ($submission)
            <a href="{{ route('checkout.with_data', $submission->dos_id) }}" class="btn cta-btn">File Now - $125</a>
        @else
