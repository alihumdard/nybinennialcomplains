...
.header .muted {
  ...
  .muted { color: var(--light-bg); font-size: 12px; }
  .body { padding: 15px; }
  .section {
...
<div class="form-card">
 <div class="header">
  <div class="logo-spot" style="overflow:hidden">
   <img src="{{ asset('assets/images/logocopy.png') }}" alt="Company Logo" style="width:100%;height:100%;object-fit:contain;">
  </div>
  <div>
  ...
  <div style="display:flex;gap:20px;flex-wrap:wrap">
    ...
    <div class="section">
      ...
      <table class="info-table">
        <tr><td>Filing Fee</td><td>$125.00</td></tr>
        <tr><td>Payment Methods</td><td>Check or Money Order (Payable to: New York Biennial Compliance)</td></tr>
        <tr><td>Mail To</td><td>69 State Street, Suite 1300 #2017, Albany, NY 12207</td></tr>
        <tr><td>Processing Time</td><td>24–48 business hours</td></tr>
      </table>
    </div>
  ...
  <div class="foot">
    This is a private compliance assistance service and is not affiliated with the New York State Department of State.
  </div>
</div>
